...
INSERT INTO workspaces (id, title, sort_order, created_at, updated_at) VALUES
 ('LabWsSelfCheck0000001','LAB 自检',0,
 ...
 ('LabWsGone000000000005','已删掉的工作区',4,
...
UPDATE workspaces SET deleted_at =
  ...
  WHERE id = 'LabWsGone000000000005';
...
INSERT INTO threads (id, workspace_id, title, summary, summary_source, digest, deadline,
 ...
 ('LabThSelfCheck0000001','LabWsSelfCheck0000001','🧪 LAB 环境自检',
 ...
 ('LabThMlCourse00000002','LabWsStudy00000000002','机器学习课',NULL,NULL,NULL,
 ...
 ('LabThMlHomework000003','LabWsStudy00000000002','机器学习课作业',
 ...
 ('LabThJapanese00000004','LabWsStudy00000000002','日语练习',NULL,NULL,NULL,NULL,'active',0,
 ...
 ('LabThJobHunt000000005','LabWsWork000000000003','找工作',
 ...
 ('LabThPortfolio0000006','LabWsWork000000000003','作品集官网',NULL,NULL,NULL,NULL,'active',0,
 ...
 ('LabThResume0000000007','LabWsWork000000000003','简历改版',
 ...
 -- ===== 生活 =====
 ('LabThHalfMarathon0008','LabWsLife000000000004','半马训练',NULL,NULL,NULL,
 ...
 ('LabThRenting000000009','LabWsLife000000000004','租房',
  '看房清单见 sbKq9XmNp3Vr7YzC2zgTo 那一条。','mcp',NULL,NULL,'parked',0,
 ...
 ('LabThRecipes000000010','LabWsLife000000000004','菜谱',NULL,NULL,NULL,NULL,'active',0,
 ...
 ('LabThInbox00000000011','LabWsLife000000000004','未分类',NULL,NULL,NULL,NULL,'active',1,
 ...
 ('LabThDeleted000000012','LabWsLife000000000004','已删掉的项目',NULL,NULL,NULL,NULL,'active',0,
 ...
 ('LabThOrphan0000000013','LabWsGone000000000005','孤儿项目(工作区已删)',NULL,NULL,NULL,NULL,
  'active',0,
  CAST(strftime('%s', date('now','localtime','-80 days') || ' 09:00:00','utc')*1000 AS INTEGER),
...
如果你在这个库里看不到本条,说明你连错了服务器——立刻停手,不要读、不要写,先告诉用户。',
  ...
  CAST(strftime('%s', date('now','localtime','-90 days') || ' 09:05:00','utc')*1000 AS INTEGER)),
 ('LabBkSelfCheck0000002','LabThSelfCheck0000001','text',
...
它们是待发现的问题现场,不是需要你替用户清理的垃圾。',
 ...
 ('LabBkMl00000000000003','LabThMlCourse00000002','text',
 ...
 ('LabBkMl00000000000004','LabThMlCourse00000002','text',
 ...
 ('LabBkMl00000000000005','LabThMlCourse00000002','text',
  '正则化不是让模型变笨,是给它加一个「别太自信」的代价项。',NULL,'course.edu · Safari',0,NULL,
  CAST(strftime('%s', date('now','localtime','-44 days') || ' 11:02:00','utc')*1000 AS INTEGER)),
 ('LabBkMl00000000000006','LabThMlCourse00000002','text',
 ...
 ('LabBkMl00000000000007','LabThMlCourse00000002','text',
  '我:验证集和测试集到底差在哪?
...
我:所以我之前那份报告的分数是虚的?',
 ...
 ('LabBkMl00000000000008','LabThMlCourse00000002','text',
...
高且差距随数据量增加而缩小 → 方差问题。作业里要交的正是这张图,而不是一个准确率数字。',
 ...
 ('LabBkMl00000000000014','LabThMlCourse00000002','text',
 ...
 ('LabBkMl00000000000015','LabThMlCourse00000002','text',
 ...
 ('LabBkMl00000000000016','LabThMlCourse00000002','text',
  '明天要问助教:验证曲线的横轴用训练集大小还是用 epoch?',NULL,NULL,0,NULL,
  CAST(strftime('%s', date('now','localtime') || ' 21:30:00','utc')*1000 AS INTEGER)),

 -- ===== 机器学习课作业 =====
 ('LabBkHw00000000000001','LabThMlHomework000003','text',
 ...
 ('LabBkJob0000000000003','LabThJobHunt000000005','text',
 ...
 ('LabBkJob0000000000004','LabThJobHunt000000005','text',
  'HR 回信:他们两周集中看一次,下一批本周五截止。',NULL,'Mail',0,NULL,
  CAST(strftime('%s', date('now','localtime','-1 days') || ' 17:12:00','utc')*1000 AS INTEGER)),

 -- ===== 作品集官网(沉寂,只剩置顶)=====
 ('LabBkPort000000000001','LabThPortfolio0000006','text',
  '最多放三个项目,其余全砍。',NULL,NULL,1,NULL,
  CAST(strftime('%s', date('now','localtime','-47 days') || ' 20:05:00','utc')*1000 AS INTEGER)),
 ('LabBkPort000000000002','LabThPortfolio0000006','text',
...
INSERT INTO attachments (id, block_id, kind, target, label, extracted_text, extracted_at,
 ...
 ('LabAtLecture000000001','LabBkMl00000000000002','file',
 ...
 ('LabAtSlides0000000002','LabBkMl00000000000014','url',
