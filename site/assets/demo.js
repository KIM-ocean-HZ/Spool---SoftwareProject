...
(function () {
  ...
  STR.en = {
    ...
    pmSub: 'Written on your own machine · ready to paste into any AI',
    ...
    finale: '<strong>That’s the whole loop.</strong> And look at the sidebar — a course, a term paper, a rebuild at work, a flat. Spool is for any project that runs longer than one sitting.<br><a class="btn btn-primary" href="https://github.com/KIM-ocean-HZ/spool/releases/latest">Download Spool</a>',
    copyLabel: '⎘ Copy',
    copied: '✓ Copied',
    keycap: '⌥ option',
    ...
    tpl: {
      ...
      packB: 'Spool writes it out on your own machine. No AI involved, and the same project always comes out the same way.',
  ...
  STR.zh = {
    ...
    pmCont: '粘贴给 AI →',
    finale: '<strong>完整流程到此结束。</strong>侧栏里还有一门课、一篇论文、工作项目和生活事项。只要一件事无法一次完成，Spool 就能持续保存它的背景。<br><a class="btn btn-primary" href="https://github.com/KIM-ocean-HZ/spool/releases/latest">下载 Spool</a>',
    copyLabel: '⎘ 复制',
    copied: '✓ 已复制',
    keycap: '⌥ Option',
    ...
    tpl: {
      ...
      packB: 'Spool 在你自己的电脑上生成 Pack，不调用 AI；相同的项目内容会按同一规则生成。',
