...
(function () {
  ...
  var ZH = {
    ...
    'tab-pack': '打包',
    'tab-digest': '沉淀',
    'cap-main': '一条脉络,五条碎片:置顶的目标、带你批注的 arXiv 原文、一段 AI 对话的回答、你自己的笔记、一封邮件。每条都留着它的时间与来源。',
    'cap-pack': '打包一条脉络:选意图与范围,复制,粘到任何地方。(图为中文界面——英文界面同样随包发布。)',
    'cap-digest': '完结脉络的沉淀页:结论、置顶块、文件与链接。(图为中文界面——英文界面同样随包发布。)',
    /* mcp */
    'mcp-k': 'MCP · 粘贴之外',
    'mcp-h': '你的 AI,常驻图书管理员',
    'mcp-p1': '一次 pack 只简报一次。通过 <strong>Model Context Protocol</strong>,你已经拥有的 AI 客户端得到的是常驻访问:按需读取数周的上下文、搜索每一条脉络、把结论归档回正确的位置。十个工具、两个需要你亲手打开的开关、不占任何网络端口。',
    'mtab-lib': '① 看见你的库',
    'mtab-digest': '② 从数周上下文里作答',
    'mtab-search': '③ 每条都知道出处',
    'mtab-file': '④ 归档回来,带署名',
    'mcap-lib': '一句大白话提问,拿到结构化的回答——客户端直接从你本机的库里读出工作区、脉络与块数。',
    'mcap-digest': '一段话,织自跨越三周捕捉的五条碎片:置顶的骨架句、你自己定的改稿顺序、arXiv 的分类法、委员会的回信。这是一次粘贴做不到的事。',
    'mcap-search': '每条命中都保着出处:哪条来自 arXiv 并带着你的批注,哪条是你自己定顺序的笔记。',
    'mcap-file1': '让它归档一条结论,它只写一个块——带批注,并引用它所依据的那条笔记。',
    'mcap-file2': '……而它在 Spool 里长这样。徽标 <strong>Claude · MCP</strong>,追加在你的笔记<strong>之下</strong>而非覆盖其上,<strong>↩</strong> 行精确引用了它所回答的那个块。',
    'mcp-note': '截图取自专门搭建的演示库,因此不含任何个人内容。',
    /* privacy strip */
    'priv-k': '隐私',
