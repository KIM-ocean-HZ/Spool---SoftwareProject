...
⚠️⚠️ **还没提交、没装机、没推送 —— 三样都要单独问 Ocean。**
...
| **这一窗 F(出处三字段,schema v20)** | ⚠️ **只在工作区,没提交** | ❌ **没装,而且现在还不能装** —— 见 §0.0 |
...
| **4** | 五句过了之后,再问他:**提交 / 装机 / 推送**,三件分开问 | ⚠️ 装 F 的注意事项在 §0.2,和以前几次**不一样** |
